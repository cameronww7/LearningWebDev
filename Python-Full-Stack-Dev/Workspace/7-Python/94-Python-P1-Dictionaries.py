...
print("my_dict['key3'][0] ", my_dict['key3'][0])

#Can then even call methods on that value
print("my_dict['key3'][0].upper() ", my_dict['key3'][0].upper())
...
print("d.keys()) ", d.keys().__str__())

# Method to grab all values
print("d.values() ", d.values().__str__())

# Method to return tuples of all items  (we'll learn about tuples soon)
print("d.items() ", d.items().__str__())
